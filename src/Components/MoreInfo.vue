...
<template>
  ...
  >
    ...
    <div class="flex flex-col overflow-y-auto md:flex-row items-center md:justify-between gap-6 mb-20">
      <!-- Wind speed -->
    ...
    <div class="flex flex-col md:flex-row items-center md:justify-between gap-6 mb-10">
      <!-- Wind direction -->
      <div class="text-center flex-1">
